...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="/add/subcategory" class="btn btn-primary">Add Category</a> 			
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="example_length"><label>Show <select name="example_length" aria-controls="example" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="example_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="example"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                    <thead>
<tr role="row">
	<th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Sl: activate to sort column ascending" style="width: 55px;" aria-sort="descending">Sl</th>
	<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Category Name : activate to sort column ascending" style="width: 287px;">Category Name </th>
	<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Subcategory Name : activate to sort column ascending" style="width: 287px;">Subcategory Name </th>
...
<?php
$num = 1;
$sql = $conn->query("SELECT sub_categories.*, categories.category FROM sub_categories
...
if ($sql->num_rows <= 0) {
	...
	<td>
		...
		if($row['status'] === '0'){
		?>
		<a href="/status/subcategory/<?= $row['id'] ?>" title="active" class="btn btn-info text-white"><i class="bx bx-like  "></i></a>
        <?php
		}else{
			?>
					<a href="/status/subcategory/<?= $row['id'] ?>" title="inactive" class="btn btn-info text-white"><i class="bx bx-dislike  "></i></a>
			<?php
		}
		?>
		<a href="/edit/subcategory/<?= $row['id'] ?>" class="btn btn-info">Edit</a>
        <a href="/delete/subcategory/<?= $row['id'] ?>" 

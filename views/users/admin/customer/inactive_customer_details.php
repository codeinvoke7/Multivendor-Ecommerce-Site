...
if (isset($_SERVER['REQUEST_URI'])) {
    ...
    $inactiveCustomer_id = explode('/', $uri);
    $inactiveCustomer_id = $inactiveCustomer_id['4'];

    $sql = $conn->query("SELECT * FROM `users` WHERE id = $inactiveCustomer_id"); 
    $row = $sql->fetch_assoc();
...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Inactive Customer Details</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Inactive Customer Details</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-12">
	<div class="card">
        ...
        <div class="row">
				...
				<div class="col-sm-9 text-secondary">
					<a href="/status/customer/active/<?= $inactiveCustomer_id ?>"><button class="btn btn-danger mb-2">Active Customer</button></a>
				</div>
			</div>

...
if (isset($_SERVER['REQUEST_URI'])) {
    ...
    $activeVendor_id = explode('/', $uri);
    $activeVendor_id = $activeVendor_id['4'];

    $sql = $conn->query("SELECT * FROM `users` WHERE id = $activeVendor_id"); 
    $row = $sql->fetch_assoc();
...
<div class="col-lg-12">
	<div class="card">
        ...
        <div class="row">
				...
				<div class="col-sm-9 text-secondary">
					<a href="/status/vendor/inactive/<?= $activeVendor_id ?>"><button class="btn btn-danger mb-2">Inactive Vendor</button></a>
				</div>
			</div>

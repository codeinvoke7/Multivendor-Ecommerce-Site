        ...
        <div class="main-body">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="<?= !empty($photo) ? $photo[1]. '.'. $photo[2] : '/views/public/uploads/no_image.jpg' ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                                    <h4>Admin</h4>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="/admin/profile/store" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <img id="showImage" src="<?= !empty($photo) ? $photo[1]. '.'. $photo[2] : '/views/public/uploads/no_image.jpg' ?>" alt="Admin" style="width:100px; height: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="submit" class="btn btn-primary px-4" name="adminProfileUpdate" value="Save Changes">
                                </div>
                            </div>
                        </form></div>

...
<div class="card">
  <div class="card-body p-4">
      ...
      <form id="myForm" method="post" action="/vendor/update/product/<?= $product_id ?>" enctype="multipart/form-data" >
...
<hr>
    ...
    <div class="page-content">
                ...
                <hr>
            <div class="card">
                <form  method="post" action="/vendor/update/product/thumbnail/<?= $product_id ?>" enctype="multipart/form-data" >
...
<div class="card-body">
	<table class="table mb-0 table-striped">
		...
		<tbody>
            ...
            <form method="post" action="/vendor/update/product/images/<?= $product_id ?>" enctype="multipart/form-data" >
   ...
   $num = 1;
	...
	<a href="/vendor/product/multiimage/delete/<?= $product_images['id'] ?>" class="btn btn-danger" id="delete" > Delete </a>	
		</td>
	</tr>

...
<div class="page-header breadcrumb-wrap">
    <div class="container">
      <div class="breadcrumb mt-2">
        ...
        <a href="shop-grid-right.html" class="me-2 text-secondary">Paystack Payment </a>
      </div>
    </div>
  </div>
  <hr>
...
if(isset($_SESSION['coupon'])):?>
 <div class="col-6  m-auto border p-3 rounded mt-2">
  ...
  <div class="form-submit">
    <button type="submit" onclick="payWithPaystack()" class="btn fillBtn">Make Payment </button>
  </div>
</form>
...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    callback: function(response){
       window.location = 'http://localhost:9000/paystack/order?reference='+ response.reference;
    //   alert(message);
    }
  });
